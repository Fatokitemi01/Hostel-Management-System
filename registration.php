...
{
	document.getElementById("lb2text").innerHTML ="Valid";
...
{
	document.getElementById("lb2text").innerHTML ="InValid";
	document.getElementById("lb2text").style.visibility ="visible";
...
<label id ="lbtext" style = "color : red;visibility:hidden">Invalid </label>
<label id ="lb1text" style = "color : red;visibility:hidden">Invalid </label>
<button class="btn btn-default"  type="submit">Cancel</button>
<input type="submit" name="submit" onclick ="Valid()" Value="Register" class="btn btn-primary">
</div>
</form>
